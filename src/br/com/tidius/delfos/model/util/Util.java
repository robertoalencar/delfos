...
public final class Util {
    ...
    /**
     * M�todo respons�vel por substituir os argumentos em um texto, ex: Ol� {0}.
     * 
     * @param texo O texto que ser� processado
     * @param numeroDeArgumentos O N�mero do arqumento
     * @param valorDoArgumento O valor do argumento
     * @return Um texto com os argumentos subtitu�dos
     */
