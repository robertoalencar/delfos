...
import br.com.tidius.delfos.model.comum.excecoes.ConcorrenciaException;
 ...
 * 
 */
public abstract class Service extends HibernateDaoSupport {
    ...
    public List<EntidadeTipo> listarTodasEntidadeRelacionamento(Class<?> classe, boolean apenasHabilitados) {
    ...
    @SuppressWarnings("unchecked")
    public List<? extends EntidadeNegocio> carregarCombobox(Boolean habilitado, Class<?> classe)
	...
	entidadeNegocio.setDataCadastro(Calendar.getInstance().getTime());
	...
	if (!existeRelacionamento(entidadeNegocio)) {
	...
	EntidadeNegocio entidadeConsultada = (EntidadeNegocio) DataAccessUtils.uniqueResult(getHibernateTemplate()
